...
const SECTIONS = [
  ...
  { id: "q5", label: "Q5 · ProductCard",    emoji: "🏷️" },
  { id: "q6", label: "Q6 · UserProfile",    emoji: "👤" },
];
  ...
  return (
    <div className="app-wrapper">
      ...
      <main className="main-content">
        ...
        {/* ── Q5 · ProductCard ── */}
        {active === "q5" && (
          <section className="section" key="q5">
            <div className="section-header">
              <span className="q-badge">Q5</span>
              <div>
                <h2 className="section-title">ProductCard — Props &amp; PropTypes</h2>
                <p className="section-sub">
                  <code>ProductCard</code> accepts <code>productName</code> (string) and <code>price</code> (number) as props.
                  The <code>prop-types</code> package validates types at runtime and logs a warning if wrong types are passed.
                </p>
              </div>
            </div>
            <div className="code-pill">
              <code>{"<ProductCard productName=\"MacBook Pro\" price={149999} />"}</code>
            </div>
            <div className="pc-grid">
              <ProductCard productName="MacBook Pro M3" price={149999} />
              <ProductCard productName="Sony WH-1000XM5" price={24990} />
              <ProductCard productName="iPhone 15 Pro" price={134900} />
            </div>
          </section>
        )}
        ...
        {/* ── Q6 · UserProfile ── */}
        {active === "q6" && (
          <section className="section" key="q6">
            <div className="section-header">
              <span className="q-badge">Q6</span>
              <div>
                <h2 className="section-title">UserProfile — defaultProps Demo</h2>
                <p className="section-sub">
                  <code>UserProfile</code> takes <code>username</code>, <code>followers</code>, and <code>profilePic</code>.
                  The last card shows <strong>defaultProps</strong> in action — no <code>followers</code> or <code>profilePic</code> passed!
                </p>
              </div>
            </div>
            <div className="code-pill">
              <code>UserProfile.defaultProps = {"{ followers: 0, profilePic: 'placeholder' }"}</code>
            </div>
            <div className="up-grid">
              {/* All props provided */}
              <UserProfile
                username="mohit.parekh"
                followers={12400}
                profilePic="https://ui-avatars.com/api/?name=Mohit+Parekh&background=7c3aed&color=fff&size=128"
              />
              {/* Only username + followers */}
              <UserProfile
                username="react.dev"
                followers={98700}
                profilePic="https://ui-avatars.com/api/?name=React+Dev&background=3b82f6&color=fff&size=128"
              />
              {/* Only username — defaultProps kick in */}
